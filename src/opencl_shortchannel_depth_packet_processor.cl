...
void kernel processPixelStage2_phase_channels(global const float3 *a_in, global const float3 *b_in, global float *phase_1, global float *phase_2, global float *ir_sums, global ushort16* channels_1, global ushort16* channels_2, global ushort16* channels_1_phase_1, global ushort16* channels_2_phase_1, global ushort16* channels_1_phase_2, global ushort16* channels_2_phase_2, constant float* camera_intrinsics, global const float* c_in)
{
  const uint i = get_global_id(0);
  float3 a = a_in[i];
  float3 b = b_in[i];
...
void filter_channels16_help(global const ushort16* channels, global float16* channels_filtered, const uint i, global const float* gauss_filt_array)
{
...
void kernel filter_channels(global const ushort16* channels_1, global const ushort16* channels_2, global float16* channels_filtered_1, global float16* channels_filtered_2, global const float* gauss_filt_array)
{
	const uint i = get_global_id(0);
...
void kernel processPixelStage2_depth_channels(global float *phase_1, global float *phase_2, global const float16* channels_filtered_1, global const float16* channels_filtered_2, global const ushort16* channels_1_phase_1, global const ushort16* channels_2_phase_1, global const ushort16* channels_1_phase_2, global const ushort16* channels_2_phase_2, global const float *x_table, global const float *z_table, global float* depth)
{
	const uint i = get_global_id(0);
